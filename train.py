...
def parse_arguments():
    ...
    parser.add_argument('--l_sobel', type=float, default=0.1, help='lambda of sobel regularization loss')
...
def train(args):
    ...
    epoch_train_losses = {'depth': [], 'vp_cd': [], 'vp_div': [], 'part_vp_cd': [],
                          'deform_cd': [], 'part_deform_cd': [], 'lap': [], 'normal': [], 'sobel': []}

    for epoch in range(args.epochs):
        n = 0
        avg_losses = {'depth': 0.0, 'vp_cd': 0.0, 'vp_div': 0.0, 'part_vp_cd': 0.0,
                      'deform_cd': 0.0, 'part_deform_cd': 0.0, 'lap': 0.0, 'normal': 0.0, 'sobel': 0.0}
        ...
        for data in progress_bar:
            ...
            progress_bar.set_description(
                ...
                'Deform = %.6f, Part Deform = %.6g, Lap = %.6f, Normal = %.6f, Sobel = %.6f'
                % (depth_mse_loss.item(), vp_cd_loss.item(), part_vp_cd_loss.item(), vp_div_loss.item(),
                   deform_cd_loss.item(), part_deform_cd_loss.item(), lap_loss.item(), normal_loss.item(), sobel_loss.item()))
        ...
        print('Epoch %d avg loss: Depth MSE = %.6f, VP CD = %.6f, Part VP CD = %.6f, VP Div = %.6f, '
              'Deform CD = %.6f, Part Deform CD = %.6f, Lap = %.6f, Normal = %.6f, Sobel = %.6f\n'
